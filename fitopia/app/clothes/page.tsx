...
const clothes = [
  ...
  { src: "/clothes/upper/1.png", name: "Casual Shirt" },
  { src: "/clothes/upper/2.png", name: "Formal Shirt" },
  { src: "/clothes/upper/3.png", name: "Leather Jacket" },
  { src: "/clothes/upper/4.png", name: "Winter Jacket" },
  { src: "/clothes/upper/5.png", name: "Denim Jeans" },
  { src: "/clothes/upper/6.png", name: "Chino Pants" },
  { src: "/clothes/upper/7.png", name: "Sneakers" },
  { src: "/clothes/upper/8.png", name: "Formal Shoes" },
  { src: "/clothes/lower/1.png", name: "Summer Dress" },
  { src: "/clothes/lower/2.png", name: "Evening Gown" },
  { src: "/clothes/lower/3.png", name: "Casual Hoodie" },
  { src: "/clothes/lower/4.png", name: "Zipped Hoodie" },
  { src: "/clothes/lower/5.png", name: "Mini Skirt" },
  { src: "/clothes/overall/1.png", name: "Maxi Skirt" },
  { src: "/clothes/overall/2.png", name: "Graphic T-Shirt" },
  { src: "/clothes/overall/3.png", name: "Plain T-Shirt" },
  { src: "/clothes/overall/4.png", name: "Casual Shirt" },
  { src: "/clothes/upper/1.png", name: "Casual Shirt" },
  { src: "/clothes/upper/2.png", name: "Formal Shirt" },
  { src: "/clothes/upper/3.png", name: "Leather Jacket" },
  { src: "/clothes/upper/4.png", name: "Winter Jacket" },
...
export default function Clothes() {
  ...
  const handleClothingClick = (clothing: { src: string; name: string }) => {
    ...
    <div className="flex flex-col w-full min-h-screen justify-center items-center gap-16 font-[family-name:var(--font-geist-sans)]">
      <div className="flex flex-col w-[85%] justify-center items-center gap-8">
        ...
        <div className="grid grid-cols-8 gap-6 w-full">
          {paginatedClothes.map(({ src, name }, index) => (
            <div
              key={index}
            ...
            >
              <div
                ...
                onClick={() => handleClothingClick({ src, name })}
              >
                <Image
                  src={src}
                  alt={name}
                ...
                />
                <p className="mt-2 text-md font-bold text-[#2E2A2B] transition-all duration-200 hover:underline text-center">
                  {name}
                </p>
              </div>
            </div>
